...
public class MeasureListAdapterHelper {
    ...
    public SimpleAdapter getAdapter(ArrayList<Measurement> measurements,
    ...
    public void updateAdapter(ArrayList<Measurement> measurements,
                              ArrayList<int[]> leftListDeg, ArrayList<int[]> rightListDeg) {
    ...
    public void oneItemUpdateAdapter(Measurement measurement, int[] leftAngle,
                                     int[] rightAngle) {
        Map<String, Object> m = new HashMap<>();
        m.put(ATTRIBUTE_MEASURE_NUMBER, measurement.getNumber());
        m.put(ATTRIBUTE_LEFTANGLE_DD, leftAngle[0] + "\u00b0");
        m.put(ATTRIBUTE_LEFTANGLE_MM, leftAngle[1] + "'");
        m.put(ATTRIBUTE_LEFTANGLE_SS, leftAngle[2] + "''");
        m.put(ATTRIBUTE_RIGHTANGLE_DD, rightAngle[0] + "\u00b0");
        m.put(ATTRIBUTE_RIGHTANGLE_MM, rightAngle[1] + "'");
        m.put(ATTRIBUTE_RIGHTANGLE_SS, rightAngle[2] + "''");
        ...
        data.set(measurement.getNumber() - 1, m);
